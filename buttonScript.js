...
let hiddenOnTablet = document.querySelectorAll('.swiper-slide--hidden--tablet');
let hiddenOnDesktop = document.querySelectorAll('.swiper-slide--hidden--desktop');
 ...
 buttonOpen.addEventListener('click', function(evt) {
    evt.preventDefault();
    buttonOpen.classList.toggle('button-open--hidden');
 ...
 buttonClose.classList.toggle('button-close--hidden');
 });
...
// swiper-slide--hidden--desktop
// swiper-slide--hidden--tablet
 //button-open--hidden
// button-close--hidden